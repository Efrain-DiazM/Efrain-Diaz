            ...
            <section className="md:w-full md:max-w-md md:mt-4">
                ...
                <h1 className=" text-Color-yellow text-center text-2xl font-bold">Enviar mensaje</h1>
                    <section className="mb-2 mt-2">
                        <input className="shadow appearance-none rounded-2xl w-full py-2 px-3 bg-PersonalGray-25 focus:outline-none focus:shadow-outline" id="username" type="text" placeholder="Nombre" />
                    </section>
                    <section className="mb-2">
                        <input className="shadow appearance-none rounded-2xl w-full py-2 px-3 bg-PersonalGray-25 focus:outline-none focus:shadow-outline" id="username" type="text" placeholder="Email" />
                    </section>
                    ...
                    <section className="flex items-center justify-center">
                        <button className="bg-ColorLetter hover:bg-Color-yellow text-PersonalGray-100 font-bold py-1 px-4 rounded focus:outline-none focus:shadow-outline" type="button">
                            Enviar
                        </button>
                    </section>
                </form>
